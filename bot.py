...
main_keyboard = ReplyKeyboardMarkup([
    ...
    # todo: показать уроки которые нужно будет пройти (c возможностью поменять дату напоминания и добавить к сегодняшнему списку уроков)
    # todo: показать пройденные уроки (с возможностью поставить напоминалку или добавить к сегодняшнему списку уроков)
], resize_keyboard=True)

# todo: меню урока должно напоминать только про 1, 2, 3 дня
# todo: меню урока должно только уметь завершать текущий и переходить к следующему

# todo: в списке всех уроков, уроков запланированных на будущее и списка пройденных уроков нужно иметь пункты
# 1) напомнить через 1, 2, 3 дня
# 2) добавить в список текущий уроков
